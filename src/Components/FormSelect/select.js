...
export function SelectCurrency({className,onChange}){
    
    return(
        <>
        <select className={className} onChange={onChange} name="user[default_currency]" id="user_default_currency">
...
<option selected="selected" value="NPR">NPR (Rs. )</option>
...
export function SelectTimezone({className}){
    
    return(
        <>
          <select className={className}  name="time_zone" id="user_time_zone">
...
<option selected="selected" value="Chennai">(GMT+05:30) Chennai</option>
...
export function SelectLanguages({className}){

    return(
        <>
        <select className={className}  name="locale" id="user_locale">
